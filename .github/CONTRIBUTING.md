...
Please do [report an issue on the issue tracker](https://github.com/OctoGuide/bot/issues/new/choose) if there's any bugfix, documentation improvement, or general enhancement you'd like to see in the repository!
