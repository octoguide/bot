...
import type { CommentEntity, Entity, IssueEntity, PullRequestEntity } from "./entities.js";
...
export type RuleListener<Located extends Entity> = (context: RuleContext, entity: Located) => Promise<void> | void;
