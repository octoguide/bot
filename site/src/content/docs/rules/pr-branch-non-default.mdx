...
[PR sent from a default `main` branch](https://github.com/OctoGuide/botExamples/pull/8#issuecomment-2839484749):
...
- [Rule source](https://github.com/OctoGuide/bot/blob/main/src/rules/prBranchNonDefault.ts)
- [Rule tests](https://github.com/OctoGuide/bot/blob/main/src/rules/prBranchNonDefault.test.ts)
