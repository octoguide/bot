...
[Pull request with a non-semantic title](https://github.com/OctoGuide/botExamples/pull/3#issuecomment-2839276016):
...
- [Rule source](https://github.com/OctoGuide/bot/blob/main/src/rules/prTitleConventional.ts)
- [Rule tests](https://github.com/OctoGuide/bot/blob/main/src/rules/prTitleConventional.test.ts)
