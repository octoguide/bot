...
[Pull request with a body not adding to the template](https://github.com/OctoGuide/examples/pull/6#issuecomment-2839460254):
...
- [Rule source](https://github.com/octoguide/bot/blob/main/src/rules/prBodyDescriptive.ts)
