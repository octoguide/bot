...
import DefaultOptions from "../../../components/DefaultOptions.astro";
...
<DefaultOptions rule="text-image-alt-text" />

## Examples

[Issue with an image lacking alt text](https://github.com/OctoGuide/examples/issues/10#issuecomment-2839495349):
...
- [Rule source](https://github.com/OctoGuide/bot/blob/main/src/rules/textImageAltText.ts)
- [Rule tests](https://github.com/OctoGuide/bot/blob/main/src/rules/textImageAltText.test.ts)
