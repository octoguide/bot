...
A factory function that takes in an object describing a rule, then returns that object directly.

```ts
import { defineRule } from "octoguide";
...
{/* TODO: Add a section for asynchronous rules. */}
{/* I'd like to have the octokit define its owner and repo, though. */}
