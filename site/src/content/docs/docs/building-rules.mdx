...
- `about`: [`RuleAbout`](/docs/types#ruleabout): Metadata about the rule.
...
This will be included in any [rule reports](/docs/types#rulereport).

At least the properties in [`RuleAbout`](/docs/types#ruleabout) are required.
...
- `context`: [`RuleContext`](/docs/types#rulecontext)
- `entity`: [`Entity`](/docs/types#entity)
